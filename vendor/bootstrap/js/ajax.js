$(document).ready(function(){
	...
	$("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
		...
		data.append('judul_buku', $("#judul_buku").val()); // Ambil data nis
		data.append('nama_peminjam', $("#nama_peminjam").val()); // Ambil data nama
		data.append('jenis_kelamin', $("#jenis_kelamin").val()); // Ambil data jenis kelamin
		data.append('jurusan', $("#jurusan").val()); // Ambil data telepon
		data.append('no_telp', $("#no_telp").val()); // Ambil data alamat
		data.append('alamat', $("#alamat").val()); // Ambil data alamat
		data.append('tgl_pinjam', $("#tgl_pinjam").val()); // Ambil data alamat
		data.append('tgl_kembali', $("#tgl_kembali").val()); // Ambil data alamat
		...
		$.ajax({
			url: 'peminjaman_buku_proses.php', // File tujuan
